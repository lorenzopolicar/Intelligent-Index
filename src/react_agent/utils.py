...
AZURE_OPENAI_ADVANCED_API_VERSION = os.getenv("AZURE_OPENAI_ADVANCED_API_VERSION")
AZURE_OPENAI_ADVANCED_DEPLOYMENT = os.getenv("AZURE_OPENAI_ADVANCED_DEPLOYMENT")
AZURE_OPENAI_ADVANCED_API_KEY = os.getenv("AZURE_OPENAI_ADVANCED_API_KEY")
AZURE_OPENAI_ADVANCED_ENDPOINT = os.getenv("AZURE_OPENAI_ADVANCED_ENDPOINT")
...
def get_advanced_llm():
    return AzureChatOpenAI(
        api_key=AZURE_OPENAI_ADVANCED_API_KEY,
        azure_endpoint=AZURE_OPENAI_ADVANCED_ENDPOINT,
        azure_deployment=AZURE_OPENAI_ADVANCED_DEPLOYMENT,
        api_version=AZURE_OPENAI_ADVANCED_API_VERSION
    )
